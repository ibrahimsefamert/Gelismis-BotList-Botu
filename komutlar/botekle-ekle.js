...
exports.run = function(client, message, args) {
  ...
  if (message.channel.id !== kanal) return message.channel.send(`<a:unlem:794638042484441170> **Botunuz için sadece <#${kanal}> kanalında başvuruda bulunabilirsin.**`).then(msg => msg.delete(10000))
