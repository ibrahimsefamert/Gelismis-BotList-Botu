  ...
  let botsahipkanal = "KANAL-İD" // bot sahiplerinin gösterileceği kanal
	...
	if (message.channel.id !== kanal) return message.channel.send(`**Başvuruda bulunulmuş bir botu yalnızca <#${kanal}> kanalında onaylayabilirsin.**`).then(msg => msg.delete(5000))
  ...
  message.channel.send(`**Başarıyla botu onayladınız.**`).then(msg => msg.delete(10000))
};
