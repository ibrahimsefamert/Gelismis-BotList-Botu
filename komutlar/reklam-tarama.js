...
const members = message.guild.members.filter(member => member.user.presence.game && /(discord.gg|http|.com|.net|.org|invite|instagram|.tv|watch|Youtube|youtube|facebook|instagram)/g.test(member.user.presence.game.name));
const memberss = message.guild.members.filter(member => member.user.username && /(discord.gg|http|.com|.net|.org|invite|instagram|.tv|watch|Youtube|youtube|facebook|instagram)/g.test(member.user.username));
